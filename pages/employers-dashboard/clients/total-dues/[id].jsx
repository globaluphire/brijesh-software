...
import ClientTotalDues from "../../../../components/dashboard-pages/employers-dashboard/clients/total-dues/ClientTotalDues";
                                        ...
                                        <div className="tabs-box">
                                            ...
                                            <div className="widget-content">
                                                { Object.keys(fetchedClientData).length !== 0 ? (
                                                    <ClientTotalDues fetchedClientData={fetchedClientData}/>
                                                ) : (
                                                    ""
                                                )}
                                            </div>
