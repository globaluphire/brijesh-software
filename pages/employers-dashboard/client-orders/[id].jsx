...
import ClientOrders from "../../../components/dashboard-pages/employers-dashboard/client-orders/components/ClientOrders";
                            ...
                            <div className="ls-widget">
                                <div className="tabs-box">
                                    <div className="widget-title">
                                        <h4>Orders of <b><i><u>{fetchedClientData.client_name}</u></i></b> </h4>
                                    </div>

                                    <div className="widget-content">
                                        {clientNumber ? (
                                            <ClientOrders fetchedClientData={fetchedClientData}/>
                                        ) : (
                                            ""
                                        )}
                                    </div>
