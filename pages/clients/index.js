...
const Clients = () => {
  ...
  const [clientInfoDialogVisible, setClientInfoDialogVisible] = useState(false);
  ...
  async function fetchClient() {
    ...
    try {
      ...
      let { data: clientData, error } = await query.order("client_created_at", {
        ascending: false,
        nullsFirst: false,
      });
          ...
          onClick={() => {
            ...
            setClientDetails((previousState) => ({
              ...
              editedClientCity: references.filter(
                (i) => i.ref_nm === "city" && i.ref_dspl === rowData.city
              )[0],
        ...
        <div className="col-12">
          <div className="card">
            <div className="flex align-items-baseline">
              <h5>All Clients!</h5>
              <small>&nbsp;(Total: {fetchedClientsData.length})</small>
            </div>
            <DataTable
