          ...
          onClick={() => {
            ...
            setLrDetails((previousState) => ({
              ...
              editedStatus: references.filter(
                (i) => i.ref_nm === "lrStatus" && i.ref_dspl === rowData.status
              )[0],
            }));
          }}
        />
    ...
    return (
      <div>
        ...
        {rowData.consignor_gst ? (
          <>
            <span className="text-xs text-500">{rowData.consignor_gst}</span>
          </>
        ) : (
          ""
        )}
    ...
    return (
      <div>
        ...
        {rowData.consignee_gst ? (
          <>
            <span className="text-xs text-500">{rowData.consignee_gst}</span>
          </>
        ) : (
          ""
        )}
