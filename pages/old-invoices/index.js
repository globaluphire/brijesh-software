...
const OldInvoices = () => {
  ...
  // all dialog states
  const [addInvoiceDialogVisible, setAddInvoiceDialogVisible] = useState(false);
  ...
  async function fetchInvoice() {
    ...
    try {
      ...
      if (invoiceData) {
        ...
        invoiceData.forEach(
          (i) => (i.invoice_updated_at = dateTimeFormat(i.invoice_updated_at))
        );
    ...
    try {
      ...
      if (error) {
        toast.current.show({
          ...
          summary: "Error",
          detail:
            "Error while marking invoice as PAID. Please try again later or contact tech support",
        });
      } else {
        toast.current.show({
          severity: "success",
      ...
      toast.current.show({
        ...
        summary: "Error",
        detail:
          "Error while mark invoice as PAID. Please try again later or contact tech support",
      });
    }
  }
        ...
        <div className="col-12">
          <div className="card">
            <div className="flex align-items-baseline">
              ...
              <small>&nbsp;(Total: {fetchedInvoiceData.length})</small>
            </div>
            <DataTable
