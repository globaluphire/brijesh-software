...
const Dashboard = () => {
  ...
  const orderCountsPerStatus = [
    ...
    },
    {
      ...
      percentage: ((totalReadyForPickup * 100) / totalOrders.length).toFixed(2),
    ...
    },
    {
      ...
      percentage: ((totalTempoUnderProcess * 100) / totalOrders.length).toFixed(
        2
      ),
    ...
    },
    {
      ...
      percentage: ((totalReadyForDelivery * 100) / totalOrders.length).toFixed(
        2
      ),
    ...
    },
    {
      ...
      percentage: ((totalCompleted * 100) / totalOrders.length).toFixed(2),
    ...
    },
    {
      ...
      percentage: ((totalCancelled * 100) / totalOrders.length).toFixed(2),
      backgroundColor: "red",
    },
  ];
  ...
  const invoiceCountsPerStatus = [
    {
      ...
      status: "Paid",
      count: totalPaid,
      percentage: ((totalPaid * 100) / (totalPaid + totalUnpaid)).toFixed(2),
    ...
    },
    {
      ...
      status: "Unpaid",
      count: totalUnpaid,
      percentage: ((totalUnpaid * 100) / (totalPaid + totalUnpaid)).toFixed(2),
              ...
              {orderCountsPerStatus.map((item) => (
                <li className="flex flex-column md:flex-row md:align-items-center md:justify-content-between mb-4">
                  <div>
                    ...
                    <div className="mt-1 text-600">(count: {item.count})</div>
                  </div>
