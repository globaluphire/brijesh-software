    ...
    <>
      <div id="print-old-lr" className="hide-old-lr-block">
        <div class="lr-grid mx-1">
          <div class="item">
            <img src="/logo.svg" alt="logo1" class="logo1" width={70} />
          </div>
          ...
          <div class="lr_date item">
            <span>
              <b>LR Date:</b>{" "}
              {selectedLRData.lr_created_date.toLocaleString("en-IN")}
            </span>
          </div>
          {selectedLRData.status === "Final" ? (
            ...
            <span class="fina_lr item" style={{ color: "darkorange" }}>
              {" "}
              {selectedLRData.status} LR
            </span>
          )}
          ...
          <span class="last_modified_date item">
            ...
            {selectedLRData.lr_last_modified_date
              ? selectedLRData.lr_last_modified_date.toLocaleString("en-IN")
              : selectedLRData.lr_created_date.toLocaleString("en-IN")}
          </span>
          ...
          <div class="terms_condition item">
            ...
            <br />
            <span>
              1. The Weight and size are subject to actual material received at
              the pickup city godown.
            </span>
            <br />
            <span>
              2. The weight and boxes will be updating as per the material
              received in the company invoice.
            </span>
            <br />
            <span>
              3. All the other terms and conditions are as mentioned behind the
              pages.
            </span>
            <br />
            <span>
              4. This LR is auto generated and shall be subjected to correction
              as signed by the warehouse supervisor.
            </span>
            <br />
          </div>
