        ...
        .insert([
          {
            ...
            name_of_pickup_point:
              radioSelection === "Pickup" ? nameOfPickupPoint : nameOfDropPoint,
            location_city:
              radioSelection === "Pickup" ? city.ref_dspl : dropCity.ref_dspl,
            address1: radioSelection === "Pickup" ? address1 : dropAddress1,
            address2: radioSelection === "Pickup" ? address2 : dropAddress2,
      ...
      if (locationError) {
          ...
          await supabase.from("location_contact").insert([
            {
              ...
              contact_name:
                radioSelection === "Pickup" ? contactName : dropContactName,
              contact_phone:
                radioSelection === "Pickup" ? contactPhone : dropContactPhone,
              contact_email:
                radioSelection === "Pickup" ? contactEmail : dropContactEmail,
            },
          ]);
        if (locationContactError) {
          ...
          toast.current.show({
            severity: "success",
            summary: "Success",
            detail: "New " + radioSelection + " location saved successfully",
          });
            ...
            <div className="card">
              ...
              <div className="p-fluid formgrid grid">
                <div className="flex field col-12 lg:col-3 md:col-6">
                  ...
                  />
                  <label htmlFor="pickupLocationSelection" className="ml-2">
                    Pickup
                  </label>
                </div>
                <div className="flex field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  <label htmlFor="dropLocationSelection" className="ml-2">
                    Drop
                  </label>
                </div>
              </div>
            ...
            <>
                ...
                <div className="card">
                  ...
                  <div className="p-fluid formgrid grid">
                    ...
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="pickupAddress1">Address 1*</label>
                      <InputText
                        id="pickupAddress1"
                        value={address1}
                      ...
                      />
                      {address1Error ? (
                        <Message severity="error" text={address1Error} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="pickupAddress2">Address 2</label>
                      <InputText
                        id="pickupAddress2"
                        value={address2}
                    ...
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {areaError ? (
                        <Message severity="error" text={areaError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {cityError ? (
                        <Message severity="error" text={cityError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {stateError ? (
                        <Message severity="error" text={stateError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {pinError ? (
                        <Message severity="error" text={pinError} />
                      ) : (
                        ""
                      )}
                    </div>
              ...
              <div className="col-12">
                <div className="card">
                  ...
                  <div className="p-fluid formgrid grid">
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="pickupContactType">Contact Type*</label>
                      <Dropdown
                        id="pickupContactType"
                        options={loactionContactTypeRefs}
                        optionLabel="ref_dspl"
                      ...
                      />
                      {contactTypeError ? (
                        <Message severity="error" text={contactTypeError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {contactNameError ? (
                        <Message severity="error" text={contactNameError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {contactPhoneError ? (
                        <Message severity="error" text={contactPhoneError} />
                      ) : (
                        ""
                      )}
                    </div>
            ...
            <>
                ...
                <div className="card">
                  ...
                  <div className="p-fluid formgrid grid">
                    <div className="field col-12 lg:col-12 md:col-6">
                      ...
                      />
                      {nameOfDropPointError ? (
                        <Message severity="error" text={nameOfDropPointError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropAddress1">Address 1*</label>
                      <InputText
                        id="dropAddress1"
                        value={dropAddress1}
                        placeholder="Enter address 1"
                      ...
                      />
                      {dropAddress1Error ? (
                        <Message severity="error" text={dropAddress1Error} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropAddress2">Address 2</label>
                      <InputText
                        id="dropAddress2"
                        value={dropAddress2}
                        placeholder="Enter address 2"
                    ...
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropArea">Area*</label>
                      <InputText
                        id="dropArea"
                        value={dropArea}
                        placeholder="Enter area"
                      ...
                      />
                      {dropAreaError ? (
                        <Message severity="error" text={dropAreaError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {dropCityError ? (
                        <Message severity="error" text={dropCityError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {dropStateError ? (
                        <Message severity="error" text={dropStateError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropPin">PIN*</label>
                      <InputNumber
                        value={dropPin}
                        onChange={(e) => {
                          setLocationFormData((previousState) => ({
                      ...
                      />
                      {dropPinError ? (
                        <Message severity="error" text={dropPinError} />
                      ) : (
                        ""
                      )}
                    </div>
              ...
              <div className="col-12">
                <div className="card">
                  ...
                  <div className="p-fluid formgrid grid">
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropContactType">Contact Type*</label>
                      <Dropdown
                        id="dropContactType"
                        options={loactionContactTypeRefs}
                        optionLabel="ref_dspl"
                      ...
                      />
                      {dropContactTypeError ? (
                        <Message severity="error" text={dropContactTypeError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      ...
                      />
                      {dropContactNameError ? (
                        <Message severity="error" text={dropContactNameError} />
                      ) : (
                        ""
                      )}
                    </div>
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropContactPhone">Phone Number</label>
                      <InputNumber
                        id="dropContactPhone"
                    ...
                    <div className="field col-12 lg:col-6 md:col-6">
                      <label htmlFor="dropContactEmail">Email Address</label>
                      <InputText
                        id="dropContactEmail"
