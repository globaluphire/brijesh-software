...
export default function AddOrderDialog({
  ...
  const [pickupMarketingContactsData, setPickupMarketingContactsData] =
    useState([]);
  const [pickupDispatchContactsData, setPickupDispatchContactsData] = useState(
    []
  );
  const [
  ...
  useEffect(() => {
    if (addOrderDialogVisible) {
      ...
      if (fetchedLocationsContactsData.length === 0) fetchLocationsContacts();
    }
  }, [addOrderDialogVisible]);
      ...
      const { data, error } = await supabase.from("lr").insert([
        {
          ...
          consignor_client_id: !Array.isArray(selectedPickupPoint)
            ? selectedPickupPoint.location_id
            : null,
          consignee_client_id: selectedClient ? selectedClient.client_id : null,
        },
      ]);
      if (error) {
        // open toast
        ...
        .insert([
          {
            ...
            pickup_location: pickupLocation ? pickupLocation.ref_dspl : "",
            drop_location: dropLocation ? dropLocation.ref_dspl : "",
            ...
            <div className="card">
              ...
              <div className="p-fluid formgrid grid">
                <div className="field col-12 lg:col-3 md:col-6">
                  ...
                  />
                  {orderCityError ? (
                    <Message severity="error" text={orderCityError} />
                  ) : (
                    ""
                  )}
                </div>
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  {clientNameError ? (
                    <Message severity="error" text={clientNameError} />
                  ) : (
                    ""
                  )}
                  {selectedClient ? (
                    <>
                      <div className="text-color-secondary text-sm px-3 pt-1">
                        ...
                        <span>
                          {selectedClient.pin ? selectedClient.pin : ""}
                        </span>
                      </div>
                    </>
                  ) : (
              ...
              <div className="p-fluid formgrid grid">
                ...
                <div className="field col-12 lg:col-3 md:col-6">
                  ...
                  <Dropdown
                    ...
                    disabled={Array.isArray(selectedPickupPoint)}
              ...
              <div className="p-fluid formgrid grid">
                <div className="field col-12 lg:col-4 md:col-6">
                  ...
                  <InputText
                    type="text"
                    value={
                      pickupLocation && pickupLocation.ref_dspl
                ...
                <div className="field col-12 lg:col-8 md:col-6">
                  <label htmlFor="consignorClientName">Client Name</label>
                  <InputText
                    type="text"
                    value={
                      selectedPickupPoint &&
              ...
              <div className="p-fluid formgrid grid">
                <div className="field col-12 lg:col-4 md:col-6">
                  ...
                  <InputText
                    type="text"
                    value={
                      orderCity && orderCity.ref_dspl ? orderCity.ref_dspl : ""
                    }
                    disabled
                  />
                </div>
                <div className="field col-12 lg:col-8 md:col-6">
                  <label htmlFor="consigneeClientName">Client Name</label>
                  <InputText
                    type="text"
                    value={
          ...
          <div className="col-12">
            <div className="card">
              ...
              <div className="p-fluid formgrid grid">
                ...
                <div className="field col-12 lg:col-6 md:col-12">
                  <label htmlFor="freightNotes">Freight Notes</label>
                  <InputTextarea
                    id="freightNotes"
                    value={freightNotes}
