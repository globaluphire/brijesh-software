...
export default function EditClientDialog({
  ...
  const resetForm = () => {
    ...
    setClientFormErrorData(JSON.parse(JSON.stringify(editClientErrorFields)));
  };
        ...
        <div className="grid p-fluid mt-1">
            ...
            <div className="card">
              ...
              <div className="p-fluid formgrid grid">
                <div className="field col-12 lg:col-3 md:col-6">
                  ...
                  />
                  {clientTypeError ? (
                    <Message severity="error" text={clientTypeError} />
                  ) : (
                    ""
                  )}
                </div>
                ...
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  <InputText
                    ...
                    onChange={(e) => {
                      setClientFormData((previousState) => ({
                        ...previousState,
                        clientGstin: e.target.value.toUpperCase(),
                      }));
                    }}
                  />
                  {clientGstinError ? (
                    <Message severity="error" text={clientGstinError} />
                  ) : (
                    ""
                  )}
                </div>
                <div className="field col-12 lg:col-6 md:col-6">
                  <label htmlFor="clientName">PAN Number</label>
                  <InputText
                    id="clientPan"
                    value={clientPan}
                    onChange={(e) => {
                ...
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  {clientPhoneError ? (
                    <Message severity="error" text={clientPhoneError} />
                  ) : (
                    ""
                  )}
                </div>
          ...
          <div className="col-12">
            <div className="card">
              ...
              <div className="p-fluid formgrid grid">
                <div className="field col-12 lg:col-3 md:col-6">
                  <label htmlFor="clientAddress1">Address 1*</label>
                  <InputText
                    id="clientAddress1"
                  ...
                  />
                  {clientAddress1Error ? (
                    <Message severity="error" text={clientAddress1Error} />
                  ) : (
                    ""
                  )}
                </div>
                ...
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  {clientAreaError ? (
                    <Message severity="error" text={clientAreaError} />
                  ) : (
                    ""
                  )}
                </div>
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  {clientCityError ? (
                    <Message severity="error" text={clientCityError} />
                  ) : (
                    ""
                  )}
                </div>
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  {clientStateError ? (
                    <Message severity="error" text={clientStateError} />
                  ) : (
                    ""
                  )}
                </div>
                <div className="field col-12 lg:col-6 md:col-6">
                  ...
                  />
                  {clientPinError ? (
                    <Message severity="error" text={clientPinError} />
                  ) : (
                    ""
                  )}
                </div>
          ...
          <div className="col-12">
            <div className="card">
              ...
              <div className="p-fluid formgrid grid">
                ...
                <div className="field col-12 lg:col-6 md:col-6">
                  <label htmlFor="clientContactPhone">Phone Number</label>
                  <InputNumber
                ...
                <div className="field col-12 lg:col-6 md:col-6">
                  <label htmlFor="clientContactEmail">Email Address</label>
                  <InputText
